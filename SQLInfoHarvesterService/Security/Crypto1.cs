...
namespace SQL_TEST.Security
{
    class Crypto2 : ICrypto
    {
        /// <summary>
        ...
        /// Encrypt(), using an identical password and salt.
        /// </summary>
        /// <param name="cipherText">The text to decrypt.</param>
        /// <param name="salt">A salt  used to generate a key for decryption.</param>
        /// <param name="password">A password used to generate a key for decryption.</param>
        
        public string Decrypt(string cipherText, string salt, string password)
        {
        ...
        public string GetRandomKey()
        {
            ...
            int KeyBitSize = 256; //Preconfigured Password Key
